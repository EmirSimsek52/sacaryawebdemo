...
function Elysee() {
  ...
  const moviesCollectionRef = collection(db, "elysee");
    ...
    <div className='bg-[white] border-2 sm:w-[350px] w-[300px] m-2 rounded-xl'>
        ...
        <div>
                  ...
                  <figure className='flex justify-center items-center'>
                    <img src="https://www.novelarentacar.com/upload/resimler/elyceee_novela_rent_a_car.png" className='rounded-xl sm:w-[310px] w-[250px] m-2 bg-[#aeb7c7] p-[10px]' />
                  </figure>
