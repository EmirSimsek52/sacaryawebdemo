    ...
    <div className='bg-[white] border-2 sm:w-[350px] w-[300px] m-2 rounded-xl'>
        ...
        <div>
                  ...
                  <h1 className='ml-6 sm:text-[26px] text-[20px]  text-[#32324e]'>
                    ...
                    {info.map((car) => (
                            <div>
                           <div className="flex flex-row mx-6 my-5 gap-8 font-thin sm:text-[20px] text-[15px]">
                    <div className='flex flex-row'>
                    <RiTeamFill className='text-[#9F32B2] mr-3' size={25}/>{car.kisi}Kişilik
                    </div>
                    <div className='flex flex-row '>
                    <RiCarFill className='text-[#9F32B2] mr-3' size={25}/>
                    {car.model}
                    </div>
                    </div>
                    <div className="flex flex-row gap-10 mx-6 my-5 font-thin border-b-[3px] border-t-[#9F32B2] sm:text-[20px] text-[15px]">
                    <div className='flex flex-row'>
                    <RiFlashlightFill className='text-[#9F32B2] mr-3' size={25}/>{car.yakit}
                    </div>
                    <div className='flex flex-row'>
                    <AiFillControl className='text-[#9F32B2] mr-3' size={25}/>
                    {car.vites}
                    </div>
                    </div>
